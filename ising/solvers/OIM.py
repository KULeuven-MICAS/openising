...
class BRIM(SolverBase):
    ...
    def solve(
        ...
        def dvdt(t, vt, coupling):
            ...
            dv = -np.sum(coupling * (V_mat.T - V_mat), axis=1)
        ...
        with HDF5Logger(file, schema) as log:
            ...
            while i < (num_iterations) and max_change > stop_criterion:
                ...
                # Runge Kutta steps
                k1 = dtOIM * dvdt(tk, previous_voltages, J)
                k2 = dtOIM * dvdt(tk + 2 / 3 * dtOIM, previous_voltages + 2 / 3 * k1, J)
